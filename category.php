...
<section class="main">
	...
	<div class="container clearfix">
		...
		<!-- start:content -->
		<?php
		if (is_category( array( 'zakoni', 'pravilnici', 'odluke', 'evidencija-javne-nabave', 'izvjestaji-drustva', 'zakoni-pravilnici-odluke', 'javna-nabava', 'objave', 'javno-nadmetanje' ) ) ) { 
